...
const cardVariants = cva("rounded-2xl text-card-foreground", {
  variants: {
    variant: {
      ...
      service:
        "border-0 bg-card shadow-card hover:shadow-hover transition-all duration-300 overflow-hidden group",
      testimonial:
        "border border-border/50 bg-cream shadow-soft p-6",
      benefit:
        "border-0 bg-soft-green p-6 transition-all duration-300 hover:shadow-soft",
    },
  },
  defaultVariants: {
    variant: "default",
